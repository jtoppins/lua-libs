...
--- Create a table compatible with being added to the task list
-- of a Waypoint.
-- @param id task ID
-- @param params the params table that defines the task
-- @return a compatible task table
...
function _t.execute(controller, tasklist, taskfunc)
	...
	for _, task in ipairs(tasklist) do
		...
		if handler ~= nil then
			...
			dcsext.env.Logger.getByName("DCSEX"):error(
