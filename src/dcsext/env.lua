...
function _t.doRPC(ctx, cmd, valtype)
	...
	elseif valtype == "boolean" then
		val = dcsext.math.toBoolean(status)
...
function _t.setBriefing(coaID, briefingText, imagePath)
	local coaName = dcsext.world.getCoalitionString(coaID)
...
_t.Mission = require("dcsext.env.Mission")
_t.terrain = require("dcsext.env.terrain")
_t.Zone    = require("dcsext.env.Zone")
